...
@section('content')
    ...
    <div class="position-relative">
        ...
        {{-- Simbología --}}
        <div class="row position-absolute top-0 start-0 z-2 pt-5 ps-5">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" class="position-absolute start-0 top-0" viewBox="0 0 1920 1150">
            @foreach ($units as $unit )
                ...
                <a href="{{route('unit', ['unit'=>$unit->name, 'contact'=>request()->query('contact') ] )}}" class="text-decoration-none position-relative">
