...
class Shape extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Number::make('Left %', 'text_x')->rules('required')->min(0)->step(0.1)->help('Posición en X del texto del polígono'),
            Number::make('Top %', 'text_y')->rules('required')->min(0)->step(0.1)->help('Posición en Y del texto del polígono'),
        ];
    }
